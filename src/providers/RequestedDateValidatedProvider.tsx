...
// helpers
import { FullDate, validateUnitsFromDate } from '../helpers/validateUnitsFromDate';
...
const requestedDateValidatedContext = createContext<PartialFullDate | null>(null);

type PartialFullDate = Partial<FullDate>;

const invalidFullDate: PartialFullDate = { year: undefined, month: undefined, day: undefined };
...
const RequestedDateValidatedProvider = ({ children }: ChildrenProp) => {
  ...
  const requestedDateValidated = year && month && day ? validateUnitsFromDate({ year, month, day }) : invalidFullDate;
